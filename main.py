...
#your webhook
hook = input("https://discord.com/api/webhooks/995075802062397501/3HyfEwttjtAqBqtEUyjvumuy2op6QC8mO63TeeuEmXjwqgMdr0gf7fCUfyYW9emkLRak"))
#number of threads
threads = int(input("1000"))
